...
const SignUp = () => {
  ...
  return (
    <div className='mx-auto max-w-lg p-9 bg-zinc-300 my-9 rounded-md'>
      ...
      <form action="" className='flex flex-col gap-4 max-w-3xl p-4'>
      <div class="relative">
  <input
    class="bg-white rounded-lg p-3 outline-none peer w-full"
    type="text"
    id="name"
    onChange={addToForm}
    name="name"
  ...
  <label
    for="name"
    class="absolute left-3 top-3 text-gray-500 pointer-events-none transition-all duration-200 transform origin-top-left scale-100 -translate-y-0 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-5"
  >
    Name
  </label>
</div>
