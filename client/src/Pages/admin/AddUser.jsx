...
const AddUser = () => {
  ...
  return (
    <div className='mx-auto max-w-lg p-9 bg-zinc-300 my-7 rounded-md'>
      <h2 className='font-semibold text-center text-4xl'>Add User</h2>
      <form action="" onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-3xl p-4'>
        ...
        <button className='bg-red-600 rounded-lg p-3 hover:bg-red-500 font-semibold uppercase hover:text-white' type='submit'>Add user</button>
      </form>
